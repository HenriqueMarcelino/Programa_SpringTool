package com.minhalojadegame.global.controller;
...
import com.minhalojadegame.global.repository.CategoriaRepository;
...
public class CategoriaController {
	...
	@GetMapping("/{descricaoPorCategoria}")
	public ResponseEntity<List<CategoriaModel>> findByDescricaoCategoria(@PathVariable String descricaoPorCategoria) {
		return ResponseEntity.ok(repository.findByDescricao(descricaoPorCategoria));
	}
